...
export default class OptionsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.musicCheck = new Checkbox(this, 200, 300, chkTexture, () => { }, ui.btnPlay);
    ...
    this.saveOptButton = new Button(this, 100, 500, btnTexture, () => { this.scene.start('Title') }, ui.btnPlay);
    this.add.existing(this.saveOptButton);

    this.cancelOptButton = new Button(this, 250, 500, btnTexture, () => { this.scene.start('Title') }, ui.btnPlay);
