...
function addIO(node, inputs, outputs) {
  ...
  inputs.forEach(function (i) {
    return node.addInput(new rete.Input(i.name, i.name, i.socket));
  });
  outputs.forEach(function (o) {
    return node.addOutput(new rete.Output(o.name, o.name, o.socket));
  });
}
...
//# sourceMappingURL=module-plugin.common.js.map
